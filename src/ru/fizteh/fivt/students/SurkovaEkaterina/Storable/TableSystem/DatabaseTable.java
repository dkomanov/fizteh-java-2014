...
import ru.fizteh.fivt.students.SurkovaEkaterina.Storable.FileMap.ATable;
import ru.fizteh.fivt.students.SurkovaEkaterina.Storable.FileMap.FileMapReader;
import ru.fizteh.fivt.students.SurkovaEkaterina.Storable.FileMap.FileMapUsage;
import ru.fizteh.fivt.students.SurkovaEkaterina.Storable.FileMap.FileMapWriter;
...
public class DatabaseTable extends ATable implements Table {
    ...
    private void writeSignatureFile() throws IOException {
        ...
        List<String> formattedColumnTypes = StorableUsage.formatColumnTypes(columnTypes);
        String signature = StorableUsage.concatenateListEntries(formattedColumnTypes);
