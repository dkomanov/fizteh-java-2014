package ru.fizteh.fivt.students.SurkovaEkaterina.Storable.FileMap;

import ru.fizteh.fivt.students.SurkovaEkaterina.Storable.TableSystem.DatabaseTableCreator;
...
public class FileMapWriter implements Closeable {
    ...
    public static void saveToFile(String filePath, Set<String> keys, DatabaseTableCreator creator)
        ...
        for (final String key : keys) {
            ...
            offset += FileMapUsage.getBytesNumber(creator.get(key), ATable.CHARSET);
        }
        for (final String key : keys) {
