 ...
 */
public class MyTableProviderParallelTest {
    @Rule
    ...
    public void testSerialize() throws IOException {
        ...
        assertEquals(result, "[3,5.2,5.4,true,\"hello\",null]");
    }
    ...
    public void testDeserialize() throws IOException, ParseException {
        Class<?>[] types = {Integer.class, Float.class, Double.class, Boolean.class, String.class, Byte.class};
        Table table = provider.createTable("table", Arrays.asList(types));
        String string = "[3,5.2,5.4,true,\"hello\",null]";
        Storeable storeable = provider.deserialize(table, string);
    ...
    public void testDeserializeWithParseExceptionIncorrectNumber() throws IOException, ParseException {
        Class<?>[] types = {Integer.class, Float.class, Double.class, Boolean.class, String.class, Byte.class};
        Table table = provider.createTable("table", Arrays.asList(types));
        String string = "[3,5.2,5.4,true,\"hello\"]";
        provider.deserialize(table, string);
    }

    @Test (expected = ParseException.class)
    public void testDeserializeWithParseExceptionIncorrectJSON() throws IOException, ParseException {
        Class<?>[] types = {Integer.class, Float.class, Double.class, Boolean.class, String.class, Byte.class};
        Table table = provider.createTable("table", Arrays.asList(types));
        String string = "Error";
        provider.deserialize(table, string);
