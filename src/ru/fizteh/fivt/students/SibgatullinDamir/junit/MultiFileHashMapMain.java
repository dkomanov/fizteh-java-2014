...
public class MultiFileHashMapMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            checkPath(rootPath);
            DatabaseJUnit.database = new MultiFileHashMap(rootPath);
    ...
    static FileMap committedTable = new FileMap();
    ...
    private static void switchCommand(String[] command) throws MyException {
        ...
        try {
            commandsForTables.get(command[0]).execute(command, DatabaseJUnit.database);
        } catch (NullPointerException e) {
            try {
