...
import ru.fizteh.fivt.students.akhtyamovpavel.threaddatabase.commands.CommandParser;
import ru.fizteh.fivt.students.akhtyamovpavel.threaddatabase.commands.CommandStorage;
import ru.fizteh.fivt.students.akhtyamovpavel.threaddatabase.commands.filemap.*;
import ru.fizteh.fivt.students.akhtyamovpavel.threaddatabase.commands.table.*;
...
public class Shell {
    ...
    private void initCommands() {
        ...
        addCommand(new ru.fizteh.fivt.students.akhtyamovpavel.threaddatabase.commands.filemap.RemoveCommand(provider));
