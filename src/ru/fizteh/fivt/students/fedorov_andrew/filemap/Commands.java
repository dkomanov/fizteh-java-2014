...
import static ru.fizteh.fivt.students.fedorov_andrew.filemap.Utility.*;
...
public class Commands {
    ...
    static class Help implements Command {
        ...
        public void execute(Shell shell, String[] args) throws HandledException {
            ...
            System.out.println("FileMap is an utility that lets you work with simple database");
            System.out.println(String.format("You can set db file to work with using environment variable '%s'",
