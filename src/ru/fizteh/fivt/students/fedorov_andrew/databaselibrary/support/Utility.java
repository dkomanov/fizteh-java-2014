...
public final class Utility {
     ...
     */
    public static void handleError(Throwable exc, String message,
	    boolean reportToUser) throws HandledException {
	if (reportToUser) {
	...
	for (Entry<K, V> entry : target.entrySet()) {
	    ...
	    if ((sourceValue == null ? targetValue != null : (!sourceValue
		    .equals(targetValue)))) {
		diffs++;
	    }
	}
