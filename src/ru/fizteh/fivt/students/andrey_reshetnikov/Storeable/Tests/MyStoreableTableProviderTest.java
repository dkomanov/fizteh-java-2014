...
public class MyStoreableTableProviderTest {
    @Rule
    ...
    public void testSetAndGetUsing() throws IOException {
        ...
        assertNull(((MyStoreableTableProvider) provider).getUsing());
        provider.createTable("table", Arrays.asList(types));
        assertNull(((MyStoreableTableProvider) provider).setUsing("toble"));
        assertNotNull(((MyStoreableTableProvider) provider).setUsing("table"));
        assertEquals(((MyStoreableTableProvider) provider).getUsing().getName(), "table");
    }
