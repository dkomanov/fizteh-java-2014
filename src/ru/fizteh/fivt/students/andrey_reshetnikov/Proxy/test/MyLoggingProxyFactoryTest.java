...
import ru.fizteh.fivt.students.andrey_reshetnikov.Proxy.MyLoggingProxyFactory;
...
public class MyLoggingProxyFactoryTest {
    ...
    public void testMethodCall() throws JSONException {
        ...
        assertEquals(object.get("class"), "ru.fizteh.fivt.students.andrey_reshetnikov.Proxy.test.TestInterfaceImpl");
