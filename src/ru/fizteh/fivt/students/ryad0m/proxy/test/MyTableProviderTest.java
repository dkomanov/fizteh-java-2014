...
import ru.fizteh.fivt.students.ryad0m.proxy.MyTableProvider;
import ru.fizteh.fivt.students.ryad0m.proxy.MyTableProviderFactory;
import ru.fizteh.fivt.students.ryad0m.proxy.TransactionTable;
...
public class MyTableProviderTest {
    ...
    public void before() throws IOException {
        ...
        providerPath = tmpFolder.newFolder("db").getAbsolutePath();
    ...
    public void doubleTableCreate() throws IOException {
        ...
        Assert.assertNull(provider.createTable("table", Arrays.asList(types)));
    }
    ...
    public void createAndRemoveTable() throws IOException {
        ...
        TableProvider sameProvider = factory.create(providerPath);
        Assert.assertNull(sameProvider.getTable("table"));
    }
    ...
    public void testDeserialize() throws IOException, ParseException {
        ...
        assertEquals((boolean) storeable.getBooleanAt(3), true);
    ...
    public void testToString() throws Exception {
        assertEquals(provider.toString(), "MyTableProvider[" + providerPath + "]");
    }
}
