...
public class MyTableTest {
    ...
    @Before
    public void initTable() throws IOException, BadFormatException {
        myTmpFolder.create();
        TableProviderFactory factory = new MyTableProviderFactory();
        dbDirPath = myTmpFolder.newFolder("db").getAbsolutePath();
    ...
    @Test
    public void testCommit() throws IOException, BadFormatException {
