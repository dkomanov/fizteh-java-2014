...
public class StoreableTableTest {
    ...
    private CurrentStoreable storeable;
    private CurrentStoreable storeable2;
    private CurrentStoreable storeable3;
    private CurrentStoreable storeable4;
    ...
    public void after() throws IOException {
        ...
        //Files.delete(new File(System.getProperty("fizteh.db.dir") + File.separator + tableName).toPath());
        try {
    ...
    public void putInvalidColumnFormat() {
        ...
        CurrentStoreable incorrectStoreable = new CurrentStoreable(signature);
    ...
    public void getColumnType() throws IOException {
        ...
        StoreableTable fullTable = provider.createTable("fullTable", fullSignature);
