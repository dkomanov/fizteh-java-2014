...
import ru.fizteh.fivt.students.Kudriavtsev_Dmitry.Proxy.MyLoggingProxyFactory;
...
public class MyLoggingProxyTest {
    ...
    public void classTest() throws JSONException {
        ...
        String log = writer.toString();
        JSONObject jsonObject = new JSONObject(log);
        Assert.assertEquals("ru.fizteh.fivt.students.Kudriavtsev_Dmitry.Proxy.Tests.TestingClass",
    ...
    public void listArgumentMethodTest() throws JSONException {
        ...
        Assert.assertEquals(size, arg.length());
        for (int i = 0; i < size; ++i) {
    ...
    public void exceptionTest() throws IOException, JSONException {
        try {
            ...
            Assert.assertEquals("java.io.IOException: Hello World!", exceptionStr);
            throw e;
        }
    }
    ...
    public void cyclicListReturningMethodTest() throws JSONException {
        ...
        Assert.assertEquals(42, res.get(2));
