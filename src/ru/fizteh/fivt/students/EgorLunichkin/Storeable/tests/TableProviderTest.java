...
import ru.fizteh.fivt.students.EgorLunichkin.Storeable.*;
...
public class TableProviderTest {
    ...
    public void testSetAndGetUsing() throws IOException {
        ...
        assertNull(((StoreableTableProvider) provider).getUsing());
        provider.createTable("table", Arrays.asList(types));
        assertNull(((StoreableTableProvider) provider).setUsing("toble"));
        assertNotNull(((StoreableTableProvider) provider).setUsing("table"));
        assertEquals(((StoreableTableProvider) provider).getUsing().getName(), "table");
    }
