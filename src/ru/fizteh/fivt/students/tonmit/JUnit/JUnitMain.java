...
public class JUnitMain {
    ...
    private static boolean exitWarning() {
        System.out.println("There are some uncommited changes! Do you want to exit without commit?(y/n)");
        ...
        if (args.length != 0) {
            ...
            try {
                ...
                for (String newCommand : s) {
                    ...
                    JUnitCommand whatToDo = dbConnector.commands.get(arguments[j]);
                    if (whatToDo == null) {
            ...
            while (true) {
                ...
                for (String newCommand : s) {
                    ...
                    JUnitCommand whatToDo = dbConnector.commands.get(arguments[0]);
                    if (whatToDo == null) {
