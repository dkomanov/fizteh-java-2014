 ...
 * 
 * Suggests that the current version from disk is saved when object instance is
 * creating.  * Further input and output is performed only at the time of table
...
public final class TableManager implements TableProvider, AutoCloseable {
    ...
    /**
     * Returns table with the specified name. Consecutive calls a method with
     * the same arguments should return the same object table if it has not been
     * removed by {@link #removeTable(String)}.
     * 
     * @param tableName
     *            name of the table.
     * @return Object represents table. If table with specified name doesn't
     *         exist returns null.
     * 
     * @throws IllegalArgumentException
     *             If the name of the table is null or invalid.
     */
    @Override
    ...
    /**
     * Creates table with specified name. Creates new table. Commits the
     * necessary disk operations.
     * 
     * @param tableName
     *            Name of the table.
     * @param columnTypes
     *            Types of table columns. Can't be empty.
     * @return Object represents table. If table with specified name exists
     *         returns null.
     * 
     * @throws IllegalArgumentException
     ...
     * @param columnTypes
     *            List of classes represents types of table columns. Can't be
     *            empty.
     * 
     * @throws DataBaseIOException
     *             If method can't create file or write to it.
     * @throws IllegalArgumentException
     ...
     *            Name of the table.
     * @throws IllegalArgumentException
     *             If table name is null or incorrect.
     * @throws IllegalStateException
     *             If table with specified name doesn't exist.
     * @throws DataBaseIOException
     *             If I/O errors occurred.
     */
    @Override
     ...
     * 
     * @param table
     *            Table, which {@link Storeable} should belong to.
    ...
    /**
     * Creates new empty {@link Storeable} for specified table, substituting
     * there the values.
     * 
     * @param table
     *            Table, which {@link Storeable} should belong to.
     * @param values
     *            List of values which are needed for initializing the fields of
     *            Storeable.
     * @return {@link Storeable}, initialized with the specified values.
     * 
     * @throws ColumnFormatException
     *             If types of provided value and columns don't match each
     *             other.
     * @throws IndexOutOfBoundsException
     *             If number of columns and provided values don't match each
     *             other.
     */
    @Override
    ...
    /**
     * Converts string in JSON format to {@link Storeable}, corresponding to the
     * structure of the table.
     * 
     * @param table
     *            Table, which {@link Storeable} should belong to.
     * @param value
     *            String, which {@link Storeable} should be read from.
     ...
     *            Table, which {@link Storeable} should belong to.
     * @param value
     *            {@link Storeable}, which should be writed.
     * @return String in JSON format.
     * 
     * @throws ColumnFormatException
     *             If types of provided value and columns of the table don't
     *             match each other.
     */
    @Override
    ...
    /**
     * Checks if object doesn't refer to invalid table manager.
     * 
     * @throws IllegalStateException
     *             If table manager is invalid.
     */
