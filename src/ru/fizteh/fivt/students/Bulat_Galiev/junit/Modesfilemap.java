...
public final class Modesfilemap {
    ...
    private static final int ARGNUMBERONE = 1;
    private static final int ARGNUMBERTWO = 2;
    private static final int ARGNUMBERTHREE = 3;
