...
import ru.fizteh.fivt.students.Bulat_Galiev.storeable.InterpreterPackage.*;
...
public final class MainStoreable {
    ...
    private static void run(final TableProvider provider, final String[] arg)
        ...
        new Interpreter(provider, new Command[] {
                            ...
                            public void accept(final TableProvider state, final String[] arg) {
                                ...
                                if (curTable != null) {
                                    ...
                                    try {
                                        ...
                                        throw new StopInterpretationException("Deserialising problem: "
                                                + e.getMessage());
                                    }
                ...
                new Command("create", 2,
                        new BiConsumer<TableProvider, String[]>() {
                            @Override
                            public void accept(final TableProvider state, final String[] arg) {

                                if (arg[2].charAt(0) != '('
                                        || arg[2].charAt(arg[2].length() - 1) != ')') {
                                    throw new IllegalArgumentException(
                                            "You must specify types in brackets.");
                                }
                                String types = arg[2].substring(1, arg[2].length()-1);
                                StringTokenizer argtok = new StringTokenizer(types, " ",
                                        false);
                                int i = 0;
