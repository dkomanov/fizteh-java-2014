package ru.fizteh.fivt.students.kolmakov_sergey.storeable;

import ru.fizteh.fivt.storage.structured.Storeable;
import ru.fizteh.fivt.storage.structured.Table;
import ru.fizteh.fivt.storage.structured.TableProvider;
import ru.fizteh.fivt.students.kolmakov_sergey.storeable.data_base_structure.*;
import ru.fizteh.fivt.students.kolmakov_sergey.storeable.interpreter.Interpreter;
import ru.fizteh.fivt.students.kolmakov_sergey.storeable.interpreter.Command;
                ...
                public void accept(DataBaseState state, String[] args) {
                    ...
                    if (currentTable != null) {
                        try {
                            ...
                            e.printStackTrace(); // TODO Delete this govnocode.
                        }
                    } else {
                        throw new RuntimeException("no table");
                    }
