package ru.fizteh.fivt.students.SmirnovAlexandr.Parallel.database.commands_parser;

import ru.fizteh.fivt.students.SmirnovAlexandr.Parallel.database.commands.DbCommand;
import ru.fizteh.fivt.students.SmirnovAlexandr.Parallel.database.commands.table_commands.*;
import ru.fizteh.fivt.students.SmirnovAlexandr.Parallel.database.commands.tableprovider_commands.CreateCommand;
import ru.fizteh.fivt.students.SmirnovAlexandr.Parallel.database.commands.tableprovider_commands.DropCommand;
import ru.fizteh.fivt.students.SmirnovAlexandr.Parallel.database.commands.tableprovider_commands.ShowTablesCommand;
import ru.fizteh.fivt.students.SmirnovAlexandr.Parallel.database.commands.tableprovider_commands.UseCommand;
...
import ru.fizteh.fivt.students.SmirnovAlexandr.Parallel.interpreter.InterpreterCommandsParser;
