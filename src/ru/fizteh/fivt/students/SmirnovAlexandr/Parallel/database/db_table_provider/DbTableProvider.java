...
import ru.fizteh.fivt.students.SmirnovAlexandr.Parallel.database.db_table.DbTable;
import ru.fizteh.fivt.students.SmirnovAlexandr.Parallel.database.db_table.TableLoaderDumper;
import ru.fizteh.fivt.students.SmirnovAlexandr.Parallel.database.db_table.TableRow;
...
public final class DbTableProvider implements TableProvider {
    ...
    private ReentrantReadWriteLock tablesMapLock = new ReentrantReadWriteLock();
