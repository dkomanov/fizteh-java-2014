package ru.fizteh.fivt.students.ilivanov.MultiFileMap.TableInterfaces;

/**
 * Представляет интерфейс для создание экземпляров {@link ru.fizteh.fivt.students.ilivanov.MultiFileMap.TableInterfaces.TableProvider}. Предполагается, что реализация интерфейса
