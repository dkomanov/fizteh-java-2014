...
public class JUnit {
    ...
    public static void regenerateFileMaps() throws Exception {
        ...
        if (currentFile.exists()) {
            if (currentFile.isDirectory()) {
                ...
                if (currentFileMap != null) {
                    if (currentTable.equals(args[1])) {
                        currentFileMap = null;
                        savedFileMap = null;
                    }
                }
                listOfTables.remove(args[1]);
            } else {
                try {
                    throw new Exception(currentFile.toString() + ": is not a directory");
                } catch (Exception exception) {
                    Logger.getLogger(JUnit.class.getName()).log(Level.SEVERE, null, exception);
                }
            }
        } else {
    ...
    public static void use(String[] args) throws Exception {
        ...
        if (currentFile.isDirectory()) {
            ...
            savedFileMap = new TreeMap(currentFileMap);
    ...
    public static void putCurrentMapToDirectory() throws Exception {
        String stringKey;
        String stringValue;
    ...
    public static void getMapFromDirectory(File currentFile) throws Exception {
    ...
    public static void commit(String[] args) throws Exception {
        putCurrentMapToDirectory();
        System.out.println(countChanges().toString());
        savedFileMap = new TreeMap(currentFileMap);
    }

    public static void rollback(String[] args) {
        System.out.println(countChanges().toString());
