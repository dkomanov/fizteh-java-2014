...
public class TestTable {
    ...
    private ParallelTableProvider provider = null;
    @Rule
    ...
    public void createTable() throws IOException {
        ...
        table = (ParallelTable) provider.getTable("testTable");
    }
    ...
    public void commitWork() throws ParseException, IOException {
        table.put("12", provider.deserialize(table, "[1,1]"));
        table.put("22", provider.deserialize(table, "[1,2]"));
        table.put("32", provider.deserialize(table, "[1,3]"));
