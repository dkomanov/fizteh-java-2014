...
import ru.fizteh.fivt.students.pershik.Parallel.ParallelTable;
import ru.fizteh.fivt.students.pershik.Parallel.ParallelTableProvider;
...
public class ParallelTableTest {
    ...
    private static ParallelTableProvider provider;
    private static ParallelTable table;
    ...
    public void readWrite() throws IOException {
        ...
        table.commit();
        ParallelTable newTable = provider.getTable("table");
