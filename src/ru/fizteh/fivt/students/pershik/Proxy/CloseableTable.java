 ...
 */
public class CloseableTable implements Table, AutoCloseable {
    private final int mod = 16;

    private String dbDirPath;
    private List<Class<?>> signature;
    private String name;
    private CloseableTableProvider provider;
    ...
    public CloseableTable(CloseableTableProvider newProvider,  String dbName,
    ...
    public CloseableTable(CloseableTable table) {
        name = table.name;
        dbDirPath = table.dbDirPath;
        db = table.db;
        signature = table.signature;
        provider = table.provider;
        providerLock = table.providerLock;
        lock = table.lock;
    }
