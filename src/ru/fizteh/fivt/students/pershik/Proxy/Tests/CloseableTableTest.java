...
import ru.fizteh.fivt.students.pershik.Proxy.CloseableTable;
import ru.fizteh.fivt.students.pershik.Proxy.CloseableTableProvider;
 ...
 */
public class CloseableTableTest {

    private static CloseableTableProviderFactory factory;
    private static CloseableTableProvider provider;
    private static CloseableTable table;
    ...
    public void before() throws IOException {
        ...
        provider = factory.create(folder.getAbsolutePath());
    ...
    public void readWrite() throws IOException {
        ...
        table.commit();
        CloseableTable newTable = provider.getTable("table");
    ...
    public void closeTest() throws Exception {
        table.close();
        CloseableTable newTable = provider.getTable(tableName);
        Assert.assertFalse(table == newTable);
        provider.createTable("table", signature);
    }

    @Test(expected = IllegalStateException.class)
    public void usageAfterClosing() throws Exception {
        table.close();
        table.getName();
    }
    ...
    public void toStringTest() {
        String res = "CloseableTable[" + folder.getAbsolutePath()
                + File.separator + "table" + "]";
        Assert.assertEquals(res, table.toString());
    }
}
