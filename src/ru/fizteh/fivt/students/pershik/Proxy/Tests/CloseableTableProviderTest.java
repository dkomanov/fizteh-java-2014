 ...
 */
public class CloseableTableProviderTest {
    ...
    @Test(expected = IllegalStateException.class)
    public void closingTable() throws Exception {
        CloseableTable table = provider.createTable("table", fullSignature);
        provider.close();
        table.getName();
    }
    ...
    public void toStringTest() {
        String res = "CloseableTableProvider" + "["
                + folder.getAbsolutePath() + "]";
        Assert.assertEquals(res, provider.toString());
    }
}
