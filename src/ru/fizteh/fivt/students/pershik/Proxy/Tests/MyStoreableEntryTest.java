...
import ru.fizteh.fivt.students.pershik.Proxy.MyStoreableEntry;
 ...
 */
public class MyStoreableEntryTest {
    MyStoreableEntry storeable;
    ...
    private void initFullStoreable() {
        ...
        storeable = new MyStoreableEntry(list);
    }
    ...
    public void toStringTest() {
        String res = "MyStoreableEntry[";
        res = res + "1,2,3,4.0,5.0,true,six";
        res = res + "]";
        initFullStoreable();
        storeable.setColumnAt(0, Integer.valueOf(1));
        storeable.setColumnAt(1, Long.valueOf(2));
        ...
        storeable.setColumnAt(5, true);
        storeable.setColumnAt(6, "six");
        Assert.assertEquals(res, storeable.toString());
    }

    @Test
    public void toStringNullTest() {
        String res = "MyStoreableEntry[";
        res = res + "1,2,3,4.0,5.0,true,";
        res = res + "]";
        initFullStoreable();
        storeable.setColumnAt(0, Integer.valueOf(1));
        storeable.setColumnAt(1, Long.valueOf(2));
