...
public class StoreableTableProviderTest {
    ...
    public void testGetTableNonExisting() throws Exception {
        StoreableTable gotTable = provider.getTable(tableName + tableName);
        assertNull(gotTable);
    }
    ...
    @Test (expected = IllegalStateException.class)
    public void testClosedTable() throws Exception {
        StoreableTable table = provider.createTable(tableName, valueTypes);
        provider.close();
        table.size();
    }
    ...
    public void testToString() throws Exception {
        ...
        correctAnswer.append(provider.getClass().getSimpleName());
        correctAnswer.append("[");
        correctAnswer.append(testDir);
        correctAnswer.append("]");
        assertEquals(correctAnswer.toString(), provider.toString());
    }
