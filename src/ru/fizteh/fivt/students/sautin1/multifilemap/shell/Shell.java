...
public class Shell<T> {
     ...
     * @throws ru.fizteh.fivt.students.sautin1.multifilemap.shell.UserInterruptException if user wants to exit.
     * @throws ru.fizteh.fivt.students.sautin1.multifilemap.shell.CommandExecuteException if any error occurs.
     */
