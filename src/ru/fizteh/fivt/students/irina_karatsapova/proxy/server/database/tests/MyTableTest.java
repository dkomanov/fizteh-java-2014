...
import ru.fizteh.fivt.students.irina_karatsapova.proxy.server.database.table_provider_factory.MyTableRaw;
...
public class MyTableTest {
    ...
    public void testToString() throws Exception {
        ...
        assertTrue(tableStr.startsWith("MyTable["));
        assertTrue(tableStr.endsWith("]"));
        String path = tableStr.substring(tableStr.indexOf('[') + 1, tableStr.lastIndexOf(']'));
        File file = Paths.get(path).toFile();
        assertEquals(oneMoreTableName, file.getName());
