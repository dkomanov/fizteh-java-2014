 ...
 */
public interface Table extends Index, AutoCloseable {
     ...
     * @throws ru.fizteh.fivt.students.irina_karatsapova.proxy.server.database.exceptions.ColumnFormatException - при попытке передать Storeable с колонками другого типа.
     */
