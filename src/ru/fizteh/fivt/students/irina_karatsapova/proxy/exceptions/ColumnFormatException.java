package ru.fizteh.fivt.students.irina_karatsapova.proxy.exceptions;

/**
 * Бросается при попытке извлечь из колонки {@link ru.fizteh.fivt.students.irina_karatsapova.proxy.interfaces.Storeable} значение не соответствующего типа,
