package ru.fizteh.fivt.students.irina_karatsapova.junit.utils;
...
public class Utils {
    ...
    public static void checkNotNull(String arg) {
        if (arg == null) {
    ...
    public static boolean checkNoChanges(TableProvider tableProvider) {
        if (tableProvider.currentTable() == null || tableProvider.currentTable().changesNumber() == 0) {
            return true;
        }
        System.out.println(tableProvider.currentTable().changesNumber() + " unsaved changes");
        return false;
    }
